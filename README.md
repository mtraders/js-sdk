...
关于如何通过用户名和密码进行自动认证，这里提供了一个示例 [example](https://github.com/mtraders/js-sdk/tree/master/example)
...
完整的例子可以点 [这里](https://github.com/mtraders/js-sdk/tree/master/example)
